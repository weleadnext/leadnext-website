...
export default async function StateDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const items = [
    {
      title: "The Cabinet",
      description: "Commissioners and executive officials appointed by the Governor.",
      icon: Users,
      href: `/initiatives/politics-and-governance/executive-eye/state/${slug}/cabinet`,
      color: "bg-teal text-white",
      hoverColor: "hover:border-teal"
    },
    {
      title: "Executive Bills",
      description: "Proposed legislation sent to the State House of Assembly.",
      icon: FileText,
      href: `/initiatives/politics-and-governance/executive-eye/state/${slug}/executive-bills`,
      color: "bg-gold text-navy",
      hoverColor: "hover:border-gold"
    },
    {
      title: "Key Projects",
      description: "Infrastructure and development projects across the state.",
      icon: Briefcase,
      href: `/initiatives/politics-and-governance/executive-eye/state/${slug}/key-projects`,
      color: "bg-blue-600 text-white",
      hoverColor: "hover:border-blue-600"
    },
    {
      title: "Budget & Finance",
      description: "State budget analysis, IGR, and fiscal performance.",
      icon: PieChart,
      href: `/initiatives/politics-and-governance/executive-eye/state/${slug}/budget-and-finance`,
    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="bg-navy py-12 px-6 text-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <FadeIn>
            <Link 
              href="/initiatives/politics-and-governance/executive-eye/state"
