...
import { CABINET_MEMBERS_QUERY } from '@/lib/sanity/queries';
...
export default async function CabinetPage() {
  const members = await client.fetch<CabinetMember[]>(CABINET_MEMBERS_QUERY);
        ...
        <div className="mx-auto max-w-7xl">
          <FadeIn>
            ...
            <p className="text-xl text-gray-200 max-w-2xl">
              Meet the Ministers and executive officials appointed to steer the affairs of the nation.
            </p>
          </FadeIn>
        </div>
      </section>
        ...
        <FadeIn>
          {members.length === 0 ? (
            <div className="text-center py-20 bg-white rounded-2xl border border-gray-200">
              ...
              <p className="text-gray-500">The cabinet list is currently being updated.</p>
            </div>
          ) : (
