...
export default function HouseOfRepsHub() {
  const items = [
    ...
    {
      title: "Bills",
      description: "Track bills introduced, debated, and passed by the House of Representatives.",
      icon: FileText,
    ...
    {
      title: "Key Projects",
      description: "Constituency projects and major legislative interventions by House members.",
      icon: Briefcase,
      href: "/work-in-progress",
    ...
    },
    {
      ...
      description: "Role in budget appropriation and financial oversight.",
      icon: PieChart,
      href: "/work-in-progress",
        ...
        <div className="mx-auto max-w-4xl relative z-10 text-center">
          <FadeIn>
            ...
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              Explore the lower chamber of Nigeria's National Assembly, representative of the people's voice and legislative power.
            </p>
          </FadeIn>
        </div>
      </section>
