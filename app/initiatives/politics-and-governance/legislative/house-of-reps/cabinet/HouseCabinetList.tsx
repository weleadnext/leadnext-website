    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="bg-navy py-12 px-6 text-white">
        <div className="mx-auto max-w-7xl">
          <FadeIn>
            <Link 
              href="/initiatives/politics-and-governance/legislative/house-of-reps"
              className="inline-flex items-center gap-2 text-teal hover:text-white mb-6 transition-colors"
            >
              <ArrowLeft className="h-4 w-4" />
              <span>Back to House Overview</span>
            </Link>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div>
                ...
                <p className="text-xl text-gray-200 max-w-2xl">
                  Meet the Speaker, Principal Officers, and Honourable Members of the House of Representatives.
                </p>
              </div>
            ...
            <div className="text-center py-20 bg-white rounded-2xl border border-gray-200">
              ...
              <p className="text-gray-500">
                {selectedState === 'All States' 
                  ...
                  : `No Representatives found for ${selectedState}.`}
              </p>
            </div>
          ) : (
